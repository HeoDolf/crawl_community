...
class BoadrItem extends React.Component {
    constructor(props, context){
        ...
        // Crawler
        this.getContentWithCrawler = this.getContentWithCrawler.bind(this);
    ...
    getContentWithCrawler( community, board, baseTime ){
        ...
        this.crawler = axios({
            ...
            this.timeout = setTimeout(()=>{
                ...
                this.getContentWithCrawler( next.community, next.board, next.baseTime )
    ...
    componentDidMount(){
        ...
        const sessionCheckAndRun = axios({
            ...
            this.getContentWithCrawler( this.props.board.community, this.props.board.name, null );
        }).catch((error)=>{
    ...
    shouldComponentUpdate(nextProps, nextState){
        if( this.state.reload !== nextState.reload || this.props.board.name !== nextProps.board.name ){
            ...
            this.getContentWithCrawler( nextProps.board.community, nextProps.board.name, null );
        }
        return true;
    }
